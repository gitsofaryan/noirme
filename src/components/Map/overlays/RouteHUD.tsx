    ...
    <AnimatePresence>
      {routingTarget && (
        <motion.div
          ...
          exit={{ y: 50, opacity: 0 }}
          className="pointer-events-auto absolute bottom-20 left-4 right-4 z-[420] max-w-lg mx-auto bg-white/90 backdrop-blur-md border border-zinc-200 rounded-3xl p-4 px-5 text-zinc-900 shadow-xl flex flex-col gap-3.5"
        >
          {/* Header row */}
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-full bg-rose-500/20 border border-rose-500/40 flex items-center justify-center text-rose-600">
              ...
              <div className="leading-tight">
                ...
                <h4 className="text-xs font-black truncate max-w-[200px] mt-0.5 leading-none text-zinc-900">
                  {routingTarget.name}
                </h4>
              </div>
            </div>
            ...
            <button
              ...
              className="p-1.5 rounded-full bg-zinc-200 hover:bg-zinc-300 text-zinc-600 hover:text-zinc-900 transition-colors cursor-pointer"
            >
              <X size={13} />
            </button>
          </div>
          ...
          <div className="flex items-center justify-between border-y border-zinc-200 py-2.5">
            {isLoadingRoute ? (
              <div className="flex items-center justify-center w-full py-0.5 text-zinc-500 gap-2">
              ...
              <>
                <div className="flex flex-col">
                  ...
                  <span className="text-sm font-black mt-1 leading-none text-zinc-900">
                ...
                <div className="flex flex-col text-right">
                  ...
                  <span className="text-sm font-black text-emerald-600 mt-1 leading-none">
                    {formatDuration(activeRoute.durationSeconds)}
                  </span>
                </div>
              </>
            ) : (
              <div className="flex items-center justify-center w-full py-0.5 text-rose-600">
